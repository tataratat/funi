...
class FuniTest(unittest.TestCase):
    ...
    def test_all_return(self):
        ...
        # sorted indices
        unique_s, ids_s, inv_s = funi.unique_float64(self.q, tol, True, True, True, True)
        ...
        # not sorted
        # sorted indices
        unique_ns, ids_ns, inv_ns = funi.unique_float64(self.q, tol, True, True, False, True)
        ...
        unique, ids, inv = funi.unique_float64(self.q, tol, False, True, True, True)
        ...
        unique, ids, inv = funi.unique_float64(self.q, tol, False, True, False, True)
        ...
        # no inverse - sorted
        unique, ids, inv = funi.unique_float64(self.q, tol, True, True, True, False)
        ...
        unique, ids, inv = funi.unique_float64(self.q, tol, True, True, False, False)
